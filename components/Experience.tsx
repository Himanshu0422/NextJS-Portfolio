...
export default function Experience() {
  return (
    <div className="bg card flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-black px-4 sm:px-6">
      <div className="p-4 sm:p-8 max-w-md md:max-w-2xl lg:max-w-4xl rounded-xl shadow-xl bg-[#1a1a1a] hover:shadow-2xl transition duration-500 transform hover:scale-105">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#e3e5c4] mb-2">
          Frontend Developer
        </h2>
        ...
        <div className="flex justify-center flex-wrap space-x-4 text-2xl sm:text-3xl md:text-4xl text-[#e3e5c4]">
